    ...
    for i in range(-1, num_users):
        if model == "lenet5":
            ...
            if dataset in ("tinyimagenet"):
                ...
                net = timm.create_model(mode, pretrained=True, num_classes=101)
            ...
            if dataset in ("tinyimagenet"):
                ...
                net = timm.create_model(model, pretrained=True, num_classes=100)
            elif dataset in ("food101"):
                net = timm.create_model(model, pretrained=True, num_classes=101)
            ...
            if dataset in ("tinyimagenet"):
                ...
                net = timm.create_model('resnet34', pretrained=True, num_classes=101)
            elif dataset in ("cifar100"):
                net = timm.create_model('resnet34', pretrained=True, num_classes=100)
            elif dataset in ("stl10"):
                net = timm.create_model('resnet34', pretrained=True, num_classes=10)
            elif dataset in ("cinic10"):
                net = timm.create_model('resnet34', pretrained=True, num_classes=10)
        elif model == "densenet121_p":
            if dataset in ("cifar100"):
                net = timm.create_model('densenet121', pretrained=True, num_classes=100)
