...
def main_fedet(args):
    ...
    for cn in range(len(num_users)):
        ...
        for idx in range(num_users[cn]):
            ...
            clients_tmp.append(Client_FedET(idx, copy.deepcopy(users_model[cn][idx]), args.local_bs, args.local_ep[cn], optim,
    ...
    for iteration in range(args.rounds):
        ...
        for kk in range(logits_locals[0].shape[0]):
            ...
            if len(temp_logits) >= 1:
                ...
                temp_weighted_logits = np.zeros(200)
    ...
    return (glob_acc_kd, final_glob, avg_final_glob, best_glob, avg_final_local, avg_best_local, duration)
...
def run_fedet(args, fname):
    ...
    for trial in range(args.ntrials):
        ...
        glob_acc_kd, final_glob, avg_final_glob, best_glob, avg_final_local, avg_best_local, \
