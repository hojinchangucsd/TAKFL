...
class Client_FedProx_MH(object):
    def __init__(self, name, model, local_bs, local_ep, mu, optim, lr, momentum, local_wd, scheduler, device, 
    ...
    def train(self, is_print = False):
        ...
        self.net.train()
        global_weight_collector = [param.data.clone() for param in self.net.parameters()]
