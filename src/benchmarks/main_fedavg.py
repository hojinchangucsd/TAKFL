...
def main_fedavg(args):
    ...
    for idx in range(args.num_users):
        ...
        clients.append(Client_FedAvg(idx, copy.deepcopy(users_model[idx]), args.local_bs, args.local_ep,
                   args.lr, args.momentum, args.device, args.wd, train_dl_local, test_dl_local))
...
#         args.lr = args.lr * (0.99**np.floor((iteration+1)/30))
#         for k in range(num_users_FL):
#             clients[k].lr = args.lr

#         if iteration > 29 and iteration%10 == 0:
...
def run_fedavg(args, fname):
    ...
    for trial in range(args.ntrials):
        ...
        fedavg_ft_local, duration, f1, f2, f3, f4, f5, f6, ff1, ff2, ff3, ff4, ff5, ff6 = main_fedavg(args)
